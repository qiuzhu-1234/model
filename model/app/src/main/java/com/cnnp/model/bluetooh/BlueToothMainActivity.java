package com.cnnp.model.bluetooh;
...
import com.cnnp.model.bluetooh.util.ClsUtils;
...
public class BlueToothMainActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch(msg.what){
                ...
                case SEND_FAILURE: //发送失败
                    Toast.makeText(BlueToothMainActivity.this, "发送失败", Toast.LENGTH_SHORT).show();
                    break;
    ...
    private void initData() {
        lvDevicesAdapter = new LVDevicesAdapter(BlueToothMainActivity.this);
